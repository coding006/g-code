...
## INSTALLATION SCRIPT
  ...
  ```html
  sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/coding006/g-code/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
...
![IMG_20220329_004739](https://user-images.githubusercontent.com/96321013/160447800-0636911d-46b1-4cd9-85df-470c0dddca80.jpg)

  ## Status Running
 
![IMG_20220329_004857](https://user-images.githubusercontent.com/96321013/160448482-ee1a3746-6da9-4f38-b372-d2b8555bba5b.jpg)

  ## Service & Port
 
![IMG_20220329_004802](https://user-images.githubusercontent.com/96321013/160448716-ee576784-a4ab-4a0a-a84c-1c16bc8f713e.jpg)
...
## Description :
  ...
  - XRAY Vmess Grpc Tls     : 443
  - XRAY Vless Grpc Tls     : 443
  - XRAY Trojan Grpc Tls    : 443
  - XRAY Trojan Tcp Tls     : 80
  - XRAY Trojan Tcp Xtls    : 80
